<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <?php
            $venta = ControladorVenta::ctrMostrarVenta("id",$_GET["idVenta"],null);
            $vendedor = ControladorUsuario::ctrMostrarUsuarios("id",$venta["id_vendedor"]);
            $cliente = ControladorCliente::ctrMostrarCliente("id",$venta["id_cliente"]);
            $porcentaje = ($venta["impuesto"] * 100) / $venta["neto"];
        ?>
            ...
            <div class="box-header with-border">
              ...
              <form role="form" method="post">
                ...
                <div class="box-body">
                    <div class="box">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-key"></i></span>
                            <input type="text" class="form-control" id="nuevocodigoVenta" name="editarcodigoVenta" value="<?php echo $venta["codigo"]; ?>" readonly />
                        </div>
                      </div>
                      <!-- /Entrada del Codigo Venta -->
                      <!-- Entrada del Cliente -->
                      ...
                      <div class="form-group row nuevoProducto">
                          <?php
                            $listasProductos = json_decode($venta["producto"],true);
                            foreach($listasProductos as $key => $valor)
                            {
                              $respuesta = ControladorProductos::ctrMostrasProductos("id",$valor["id"],"id");
                              echo '<div class="row" style="padding: 5px 15px">
                                      <!-- Descripcion del producto -->
                                      <div class="col-xs-6" style="padding-right:0px">
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <button type="button" class="btn btn-danger btn-xs quitarProducto" idProducto="'.$valor["id"].'">
                                              <i Class="fa fa-times"></i>
                                            </button>
                                          </span>
                                          <input type="text" class="form-control nuevaDescripcionProducto" name="nuevaDescripcionProducto" idProducto="'.$valor["id"].'" value="'.$valor["descripcion"].'" readonly required />
                                        </div>
                                      </div>
                                      <!-- /Descripcion del producto -->
                                      <!-- Cantidad del producto -->
                                      <div class="col-xs-3 ingresoCantidad">
                                        <input type="number" class="form-control nuevoCantidadProducto" name="nuevoCantidadProducto" min="1" stock="'.($respuesta["stock"] + $valor["cantidad"]).'" nuevoStock="'.$valor["stock"].'" value="'.$valor["cantidad"].'" required />
                                      </div>
                                      <!-- /Cantidad del producto -->
                                      <!-- Precio del producto -->
                                      <div class="col-xs-3 ingresoPresio" style="padding-left:0px">
                                        <div class="input-group">
                                          ...
                                          <input type="text" class="form-control nuevoPrecioProducto" name="nuevoPrecioProducto" precioReal = "'.$respuesta["precio_venta"].'" value="'.$valor["precio"].'" readonly required />
                                        </div>
                                      </div>
                                      <!-- /Precio del producto -->
                                    </div>';
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              <tr>
                                <td style="width:40%">
                                  <div class="input-group">
                                    <input type="number" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="<?php echo $porcentaje; ?>" required />
                                ...
                                <td style="width:50%">
                                    <div class="input-group">
                                      <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                                      <input type="text" class="form-control input-lg" min="1" id="nuevoTotalVenta" name="nuevoTotalVenta" total="<?php echo $venta["neto"]; ?>" value="<?php echo $venta["total"]; ?>" readonly required />
                ...
                <div class="box-footer">
                  <button type="submit" class="btn btn-primary pull-right">Guardar Cambio</button>
                </div>
                <!-- /box footer -->
              </form>
              <!-- /formulario -->
